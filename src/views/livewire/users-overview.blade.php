<div>
    <div class="flex w-full pt-2">
        ...
        <div class="w-1/3">
            <a href="{{ route('permissions.users.management') }}" class="inline-flex items-center float-right px-4 py-2 font-bold text-white bg-green-700 rounded-full hover:bg-green-900">
